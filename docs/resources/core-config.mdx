...
| `CS2ServerGuidelines`          | `string`   | `"https://blog.counter-strike.net/index.php/server_guidelines/"` | Only registered on CS2. URL referenced by the server guidelines behavior.                                  |
